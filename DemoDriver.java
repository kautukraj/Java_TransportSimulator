...
public class DemoDriver implements AppControl
{
	...
	public static void main(String[] args)
	{
		...
		// in the following, replace the "demo" with the package name of each member of the group
		...
		driver.initialize(demoFactories); // get the input
	...
	private void initialize(ArrayList<Factory> factories2)
	{
		...
		// read in trucks - create 2 trucks for each input line; one at x,y and other at x+5, y+5
